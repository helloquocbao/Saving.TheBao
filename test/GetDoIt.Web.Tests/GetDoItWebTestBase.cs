...
{
    public abstract class GetDoItWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GetDoItWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GetDoItWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GetDoItDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GetDoItDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GetDoItDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GetDoItDbContext, Task<T>> func)
        {
            T result;
